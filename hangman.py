...
words = 'аист акула бабуин баран барсук бобр бык верблюд волк воробей ворон выдра голубь гусь жаба зебра змея' \
       ...
       'питон попугай пума сеика скунс собака сова тигр тритон тюлень утка форель хорек черепаха ястреб'.split()
...
def getGuess(alreadyGuessed):
    # Возвращает букву, выделенную игроком. Эта функция проверяет, что игрок ввел только одну букву и ничего больше
    while True:
        print('Введите букву.')
        guess = input()
        guess = guess.lower()
...
while True:
    ...
    if guess in secretWord:
        ...
        'Неугадано букв: ' + str(len(missedLetters)) + ', и угадано букв: ' + str(len(correctLetters)) +
